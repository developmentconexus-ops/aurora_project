...
| [ADR-0003](0003-m0-go-core-runtime.md) | Go as the Initial Aurora Sovereign Core Runtime | accepted | Go for the Sovereign Core; agentic/Harness runtimes remain free behind contracts |
