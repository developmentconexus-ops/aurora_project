...
source_of_truth_for:
  - MR-01 methodology and repository rebaseline decision
...
> **ACCEPTED / OPERATOR-RATIFIED.** The operator approved the MR-01 design direction on 2026-08-23. This durable candidate still requires exact constitutional reconciliation, migration planning, independent challenge and final operator ratification before it can replace current `main` authority.
...
| `docs/roadmap.md` as mutable authority | SUPERSEDE AFTER MIGRATION | `docs/roadmap.md` becomes sole mutable stage/status/allowed-work/next-action authority |
