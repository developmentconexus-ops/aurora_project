...
| `CAP-SOVEREIGN-CORE-REQ-114` | docs/roadmap.md MUST record current R2 verdict, authorizations/prohibitions, blockers, fixed verification targets and exact next action after R2 closeout. | high | DOCUMENT_REVIEW | `AUR-REQ-DOC-012`, `AUR-REQ-RDM-002` |
