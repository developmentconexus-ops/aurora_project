...
source_of_truth_for:
  - proposed Aurora repository-local specialization of DevelopmentConexus Method and Repository Standard
  - proposed Aurora-specific stop conditions and verification posture
related:
...
> **PROPOSED.** This document is repository-local specialization only. It becomes active only if MR-01 is finally ratified and integrated.
